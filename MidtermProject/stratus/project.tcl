...
define_hls_module Matrix_Mult ../MatrixMult.cpp

### 4. Define your HLS configuration (arbitrary names, BASIC and DPA in this example). 
define_hls_config Matrix_Mult BASIC
define_hls_config Matrix_Mult DPA       --dpopt_auto=op,expr

set IMAGE_DIR           ".."
set IN_FILE_NAME        "${IMAGE_DIR}/Stimulus.dat"
set OUT_FILE_NAME		"out.dat"
...
define_sim_config V_BASIC "Matrix_Mult RTL_V BASIC" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
### 5.3 The Verilog simulation for HLS config "DPA". 
define_sim_config V_DPA "Matrix_Mult RTL_V DPA" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
