...
define_hls_config GaussianFilter UNROLL_CONV
define_hls_config GaussianFilter UNROLL_CONV_PIPELINE
...
### 5.4 The Verilog simulation for HLS config "UNROLL_CONV". 
define_sim_config V_UNROLL_CONV "GaussianFilter RTL_V UNROLL_CONV" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
### 5.5 The Verilog simulation for HLS config "UNROLL_CONV_PIPELINE". 
define_sim_config V_UNROLL_CONV_PIPELINE "GaussianFilter RTL_V UNROLL_CONV_PIPELINE" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
### 5.5 The Verilog simulation for HLS config "FLAT_UNROLL_ALL". 
define_sim_config V_FLAT_UNROLL_ALL "GaussianFilter RTL_V FLAT_UNROLL_ALL" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
