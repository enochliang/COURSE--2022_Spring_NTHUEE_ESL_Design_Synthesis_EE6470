...
public:
  sc_in_clk i_clk;
  sc_out<bool> o_rst;
  sc_fifo_out<unsigned char> o_r[256];
  sc_fifo_out<unsigned char> o_g[256];
  sc_fifo_out<unsigned char> o_b[256];
  sc_fifo_in<int> i_r_result[256];
  sc_fifo_in<int> i_g_result[256];
  sc_fifo_in<int> i_b_result[256];
